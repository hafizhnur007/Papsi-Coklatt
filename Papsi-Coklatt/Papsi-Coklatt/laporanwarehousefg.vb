...
Public Class laporanwarehousefg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Papsi_Coklatt.laporanwarehousefg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanwarehousefg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanwarehousefg = New laporanwarehousefg()
        rpt.Site = Me.Site
        Return rpt
    End Function
