...
Public Class laporanplanning
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Papsi_Coklatt.laporanplanning.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanplanning
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanplanning = New laporanplanning()
        rpt.Site = Me.Site
        Return rpt
    End Function
