...
Public Class laporanpurchasing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Papsi_Coklatt.laporanpurchasing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanpurchasing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanpurchasing = New laporanpurchasing()
        rpt.Site = Me.Site
        Return rpt
    End Function
