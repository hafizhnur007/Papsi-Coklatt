...
Public Class laporanmarketing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Papsi_Coklatt.laporanmarketing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanmarketing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanmarketing = New laporanmarketing()
        rpt.Site = Me.Site
        Return rpt
    End Function
